...
const BLOG = {
  ...
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'dark', // 🌙 改为夜间模式 ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '趣集客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '趣集客 — 让我们共同分享有趣！分享好用的免费软件、效率工具与有趣网站，附详细使用教程与技巧。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.qjk8.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '趣集客,博客,免费资源,免费软件,效率工具,趣网站', // 网站关键词 英文逗号隔开
