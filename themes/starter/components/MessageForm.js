  ...
  return (
    <>
      <h3 className='mb-8 text-2xl font-semibold text-dark dark:text-white md:text-[28px] md:leading-[1.42]'>
        {starterConfig('STARTER_CONTACT_MSG_TITLE')}
      </h3>
      <form ref={formRef}>
        <div className='mb-[22px]'>
          <label
            ...
            {starterConfig('STARTER_CONTACT_MSG_NAME')}*
          </label>
          <input
            disabled={success}
            type='text'
        ...
        <div className='mb-[22px]'>
          <label
            // for="email"
            className='mb-4 block text-sm text-body-color dark:text-dark-6'>
            {starterConfig('STARTER_CONTACT_MSG_EMAIL')}*
          </label>
          <input
            disabled={success}
            type='email'
        ...
        <div className='mb-[22px]'>
          <label
            // for="phone"
            className='mb-4 block text-sm text-body-color dark:text-dark-6'>
            {starterConfig('STARTER_CONTACT_MSG_PHONE')}*
          </label>
          <input
            disabled={success}
            type='text'
        ...
        <div className='mb-[30px]'>
          <label
            // for="message"
            className='mb-4 block text-sm text-body-color dark:text-dark-6'>
            {starterConfig('STARTER_CONTACT_MSG_TEXT')}*
          </label>
          <textarea
            disabled={success}
            name='message'
        ...
        <div className='mb-0'>
          <button
            ...
            {starterConfig('STARTER_CONTACT_MSG_SEND')}
          </button>
          {/* Success message */}
          {success && (
            <p className='mt-2 text-green-600 text-sm'>
              {starterConfig('STARTER_CONTACT_MSG_THANKS')}
            </p>
          )}
        </div>
      </form>
